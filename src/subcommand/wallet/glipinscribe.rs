...
impl GlipInscribe {
  pub(crate) fn run(self, options: Options) -> Result {
    ...
    let (unsigned_commit_tx, reveal_tx, recovery_key_pair) =
      GlipInscribe::create_inscription_transactions(
        self.satpoint,
        inscription,
        inscriptions,
...
mod tests {
  ...
  fn reveal_transaction_pays_fee() {
    ...
    let (commit_tx, reveal_tx, _private_key) = GlipInscribe::create_inscription_transactions(
      Some(satpoint(1, 0)),
      inscription,
      BTreeMap::new(),
      Network::Bitcoin,
  ...
  fn inscript_tansactions_opt_in_to_rbf() {
    ...
    let (commit_tx, reveal_tx, _) = GlipInscribe::create_inscription_transactions(
      Some(satpoint(1, 0)),
      inscription,
      BTreeMap::new(),
      Network::Bitcoin,
  ...
  fn inscribe_with_no_satpoint_and_no_cardinal_utxos() {
    ...
    let error = GlipInscribe::create_inscription_transactions(
      satpoint,
      inscription,
      inscriptions,
      Network::Bitcoin,
  ...
  fn inscribe_with_no_satpoint_and_enough_cardinal_utxos() {
    ...
    assert!(GlipInscribe::create_inscription_transactions(
      satpoint,
      inscription,
      inscriptions,
      Network::Bitcoin,
  ...
  fn inscribe_with_no_max_standard_tx_weight() {
    ...
    let (_commit_tx, reveal_tx, _private_key) = GlipInscribe::create_inscription_transactions(
      satpoint,
      inscription,
      BTreeMap::new(),
      Network::Bitcoin,
